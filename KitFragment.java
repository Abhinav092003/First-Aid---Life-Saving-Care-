...
import com.example.firstaid.HomeActivity;
import com.example.firstaid.R;
import com.example.firstaid.SmallActivity;
import com.example.firstaid.TravelActivity;
...
public class KitFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImageView i1 = view.findViewById(R.id.smallkit);
        ImageView i2 = view.findViewById(R.id.homekit);
        ImageView i3 =view.findViewById(R.id.travelkit);
        i1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), SmallActivity.class);
